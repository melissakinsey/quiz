...
var questions = [{
    ...
    choice1: "A code export bundled into a package that can be uploaded as an app",
    choice2: "A standard format for delivering sample apps",
    choice3: "A piece of code that performs job routines in software, like a cron job",
    choice4: "An interface that allows two computers, apps, or systems to talk to each other programmatically",

    question: "What is open-source documentation?",
    choice1: "The documentation lists the open source licenses for a product",
    choice2: "The documentation source is open and available for anyone to consult",
    choice3: "The source of the documentation is based on open-source libraries",
    choice4: "Anyone can usually fork, re-use, and contribute to the contentCorrect answer",
    ...
    choice1: "The packet of information returned to the caller after a routine finishes",
    choice2: "A recursive function that creates a loop",
    choice3: "A parameter pointing to an earlier reference value",
    choice4: "A function passed as an argument so that the function is called when a process finishes",
    ...
    choice4: "A system that ensures compatibility of code, tools, apps, and plugins",
